...
vlog -compat -work work +acc=rnbp +perceptron_test. +perceptron.svm. "$env(SOURCE_FOLDER)/svm.v" "$env(SOURCE_FOLDER)/DRUM6_16_16.v" "$env(SOURCE_FOLDER)/DRUM6_16_32.v" "perceptron_test.v"
vsim -c -t 1ps +transport_int_delays +transport_path_delays -novopt -L work perceptron_test
